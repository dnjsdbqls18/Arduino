...
void loop()
{
  ...
  if(maze_status == 4) // 왼쪽 가운데 오른쪽
  {
    ...
    motor_B_contro1(HIGH,107);  //왼쪽은 전진
    delay(870);
 ...
 else if(maze_status == 3) // 오른쪽 가운데
  {
    ...
    //앞면 오른면만 있을 때 왼쪽
    Serial.println("Rotate CCW");
    motor_A_contro1(HIGH,70);  //오른쪽은 전진
    motor_B_contro1(HIGH,59);  //왼쪽은 전진
    delay(940);
   ...
   else if(maze_status == 2) // 왼쪽 가운데
  {
    ...
    //앞면 왼쪽면만 있을 때 오른쪽
    Serial.println("Rotate CCW");
    motor_A_contro1(LOW,82);  //오른쪽은 전진
    motor_B_contro1(LOW,73);  //왼쪽은 전진
    delay(750); 
    ...
    motor_B_contro1(LOW,100);  //왼쪽은 전진
    delay(800);
  }
