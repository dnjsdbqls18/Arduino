...
void setup()
{
  ...
  */
  ...
  void loop(){
    ...
    target_heading_angle = 84;    // 우회전
    imu_rotation();
    run_heading_angle();
    
   
    target_heading_angle = 267;
    imu_rotation();
    run_heading_angle_no2();

    target_heading_angle = 330;         // 좌회전
    imu_rotation();
    run_heading_angle();
    ...
    target_heading_angle = 318.5;  // 우회전
    imu_rotation();
    run_heading_angle();

    target_heading_angle = 9.5;      // 좌회전
    imu_rotation();
    run_heading_angle_no4();
